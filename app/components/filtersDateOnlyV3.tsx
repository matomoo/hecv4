...
function FiltersDateOnlyV3({ searchParams }: { searchParams: any }) {
  ...
  const onFinish = (values: any) => {
    ...
    router.refresh()
    setTempSearchParam(formattedData)
      ...
      <div className="flex justify-between p-5 border rounded-sm border-solid border-gray-300 mb-5 items-center mt-5">
        ...
        <div className="flex gap-5">
          ...
          <Button
            type="primary"
            onClick={() => {
              searchParams.tgl_registrasi = tempSearchParam !== null ? (dayjs(tempSearchParam.tgl_registrasi)) : ''
              setShowFiltersModal(true);
            }}
          >
            Show Filters
...
export default FiltersDateOnlyV3;
