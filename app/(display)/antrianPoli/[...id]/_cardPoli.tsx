...
const CardPoli = ({ namaPoli }: { namaPoli: string }) => {
  ...
  return (
    <div >
      ...
      <div className='text-5xl text-slate-200 ml-2 mb-6'>{dataAntrianPeriksaPoli?.nm_dokter}</div>
      <div className='text-4xl text-slate-300'>{'Pasien atas nama :'} {dataAntrianPeriksaPoli?.nm_pasien} ( {dataAntrianPeriksaPoli?.no_rkm_medis} )</div>
    </div>
  )
}
