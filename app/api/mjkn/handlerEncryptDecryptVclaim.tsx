...
export function prepareHeaderVclaim(): any {
  const userKeyx: string = "8072257a3514d52c24b30043e1eeaa52";
...
export function decryptAndDecompressVclaim(txtEnc: string, key: string): string {
